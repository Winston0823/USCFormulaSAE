...
const teamsData: Record<string, TeamData> = {
  ...
  powertrain: {
    ...
    heroHighlight: "pace",
    lead: "Motors, inverters, drive control, cooling. We take the energy from the pack and turn it into track performance.",
    sub: "Motor control theory meets thermal management. Our job starts where the HV bus ends and doesn't stop until the wheel turns.",
    ...
    skills: ["Motor controls", "Control systems", "Thermal analysis", "MATLAB/Simulink", "Powertrain testing", "Data analysis"],
    tools: [
      { name: "MATLAB/Simulink", category: "simulation" },
      { name: "SolidWorks", category: "cad" },
      { name: "Dynamometer", category: "testing" },
      { name: "Thermal camera", category: "analysis" },
      { name: "Inverter tuning suite", category: "calibration" },
  ...
  accumulator: {
    name: "Accumulator",
    index: 5,
    tagline: "We build the heart of the car.",
    heroHighlight: "heart",
    lead: "The high-voltage battery pack is the single biggest system on the car. We design, build, and validate every cell, every module, every millivolt of it.",
    sub: "Hundreds of cells, custom BMS, a lot of insulation, and a hard line on safety. The accumulator is where energy lives until the driver asks for it.",
    collageImgs: ["/powertrain.jpg", "/collab-on-car.jpg", "/competition-2025-4.jpg"],
    collageCaptions: ["segment build", "HV test day", "competition '25"],
    wwdCards: [
    ...
    tools: [
      ...
      { name: "Fluke HV Meter", category: "validation" },
      { name: "Spot welder", category: "assembly" },
      { name: "ANSYS Thermal", category: "simulation" },
...
const teamOrder = ["aerodynamics","frame","drivetrain","powertrain","accumulator","vehicle-dynamics","ergonomics","electrical","communications","business"];
